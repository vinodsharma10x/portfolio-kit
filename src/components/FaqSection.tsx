          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-between text-left px-6 py-5 bg-gray-50 dark:bg-gray-900 rounded-2xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors group"
              >
                ...
                <span
                  className={`flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full transition-all duration-300 ${
                    openIndex === index
                      ...
                      : "bg-gray-200 dark:bg-gray-800 text-gray-500 dark:text-gray-400 group-hover:bg-brand-100 group-hover:text-brand-500"
                  }`}
                >
                  <svg
                    width="14"
              ...
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <p className="px-6 pt-3 pb-5 text-gray-500 dark:text-gray-400 leading-relaxed">
                      {faq.answer}
                    </p>
                  </motion.div>
                )}
